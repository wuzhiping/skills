...
Environment Variables:
    SEARXNG_BASE_URL    - SearXNG instance URL (default: http://q.feg.cn)
...
class SearXNGSearchTool:
    ...
    def __init__(
        ...
        self.base_url = (
            base_url
            or os.environ.get("SEARXNG_BASE_URL", "http://q.feg.cn")
        ).rstrip("/")
...
def main():
    ...
    parser.add_argument(
        "--base-url",
        default=None,
        help="SearXNG instance URL (default: $SEARXNG_BASE_URL or http://q.feg.cn)",
    )
    parser.add_argument(
        "--categories",
        default=None,
